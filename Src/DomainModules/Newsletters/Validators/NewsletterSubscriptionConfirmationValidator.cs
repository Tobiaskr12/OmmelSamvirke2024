...
public class NewsletterSubscriptionConfirmationValidator : AbstractValidator<NewsletterSubscriptionConfirmation>
{
    public NewsletterSubscriptionConfirmationValidator()
    {
