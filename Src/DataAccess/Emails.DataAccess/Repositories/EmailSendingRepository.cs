...
using Emails.DataAccess.Enums;
using Emails.DataAccess.Errors;
using Emails.DataAccess.Interfaces;
...
namespace Emails.DataAccess.Repositories;
...
public class EmailSendingRepository : IEmailSendingRepository
{
    ...
    public EmailSendingRepository(DbContext context, ILogger logger)
    {
        _context = context;
        _logger = logger;
    }
