...
public class Email
{
    ...
    public static Result<Email> Create(string subject, string body, Recipient recipient, List<Attachment>? attachments = null)
    {
        return Create(subject, body, new List<Recipient> { recipient }, attachments);
    }

    public static Result<Email> Create(string subject, string body, List<Recipient>? recipients, List<Attachment>? attachments = null)
    {
