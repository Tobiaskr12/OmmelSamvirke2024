...
//         _logger = ServiceRegistry.GetService<ILoggingHandler>();
//     }
//     
...
//
//         public TestCommandHandler(ILoggingHandler logger)
//         {
//             _logger = logger;
//         }
//
...
//         {
//             _logger.LogInformation($"Processing command with name: {request.Name}");
//
